...
def main(_):
    #images_path = os.path.join('H:\\yan\\fruitClassification2\\datasets\\images\\', '*.jpg')
    images_path = os.path.join('H:\\yan\\fruitClassification2\\datasets\\fruit64_48\\', '*.jpg')
    images_record_path = 'H:\\yan\\fruitClassification2\\datasets\\train.record'
