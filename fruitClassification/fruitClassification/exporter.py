...
def main():
    ...
    input_shape = [None, wid, h, 3]
    export_inference_graph('image_tensor', cls_model, 'H:\\yan\\fruitClassification2\\datasets\\path_to_log_directory\\model.ckpt-2493', 'H:\\yan\\fruitClassification2\\datasets\\pbpath', input_shape)
